...
<div id="main">
    ...
    <div class="container">
        <h1>Tambah Pascapanen</h1>

        <form action="{{ route('pascapanen/store', $panen->id) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="tanggal_kemasan" name="tanggal_kemasan">
            </div>
